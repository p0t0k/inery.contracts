...
namespace inery {
   ...
   /**
    * @defgroup inerymsig inery.msig
    * @ingroup inerycontracts
    * inery.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   ...
   /** @}*/ // end of @defgroup inerymsig inery.msig
} /// namespace inery
